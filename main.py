...
# === Connect to MongoDB ===
try:
    # Using the provided local MongoDB connection string
    connection_string = "mongodb://localhost:27017/inertiafit"
    
    client = MongoClient(connection_string, serverSelectionTimeoutMS=5000)
    client.server_info()  # Test connection
    db = client["inertiafit"]  # Database name
    collection = db["exercise"]  # Collection name
